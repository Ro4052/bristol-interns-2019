    ...
    render() {
        return (
            <div className={styles.myCards}>
                <CardList cards={this.props.cards} handleClick={this.props.selectCard} hidden={false} myCards={true} isEnabled={() => this.props.playCard && !this.props.playedCardId} cy={"my-cards"} />
            </div>
        );
    }
}
