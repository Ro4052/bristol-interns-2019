...
import { joinRoom, leaveRoom, addAIPlayer } from '../LobbyActions';
    ...
    render() {
        ...
        return (
            <div className={styles.room} key={this.props.room.roomId} data-cy="room">
                ...
                {!this.props.room.started && inRoom && <Button cy="automated-player" handleClick={() => this.props.addAIPlayer(this.props.room.roomId)} text="Add automated player" />}
            </div>
        );
    }
}
