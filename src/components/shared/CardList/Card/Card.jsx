...
export class Card extends React.Component {
    ...
    render() {
        return (
            <div data-cy={`card-wrapper-${this.props.enabled ? 'enabled' : 'disabled'}`} className={cx(styles.cardWrapper, { enabled: this.props.enabled }, { disabled: !this.props.enabled }, {selected : this.props.playedCard === this.props.card.cardId})} onClick={this.handleClick}>
