...
class GameLogic {
    ...
    getState(username) {
        return {
            playedCards: { cards: this.playedCards, hidden: !(this.status === statusTypes.WAITING_FOR_VOTES || this.status === statusTypes.DISPLAY_ALL_VOTES) },
    ...
    */
    ...
    getPlayedCards() { return this.shuffle(this.playedCards) };
